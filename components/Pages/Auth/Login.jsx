...
export default function LoginScreen() {
  ...
  return (
    <ScrollView>
      <View className="bg-gray-100 h-[100vh] flex flex-col justify-center">
        ...
        <Text className="py-2">Do not have account   <TouchableOpacity className="bg-black py-4 rounded-full" onPress={() => navigation.navigate("stack/signup")}>
            <Text className="text-center text-white font-semibold">SIGN IN</Text>
